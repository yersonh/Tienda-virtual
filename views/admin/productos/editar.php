...
<style>
    ...
    .form-group label { color: #3b82f6; font-weight: 600; font-size: 13px; }
    .form-group input,
    .form-group select,
    .form-group textarea {
    ...
    .compat-row input:focus { outline: none; border-color: #3b82f6; }
    ...
    .form-actions {
        ...
        padding-top: 16px; border-top: 1px solid rgba(59,130,246,0.1);
    }
    .btn-guardar {
        background: linear-gradient(135deg, #2563eb, #3b82f6);
