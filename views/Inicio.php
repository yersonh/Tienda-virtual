...
<style>
:root {
    --inicio-surface: rgba(15, 27, 46, 0.72);
    --inicio-surface-strong: rgba(15, 27, 46, 0.84);
    --inicio-border: rgba(59, 130, 246, 0.20);
    --inicio-text: #e9f2ff;
    --inicio-muted: #94a3b8;
    --inicio-accent: #3b82f6;
    --inicio-accent-strong: #2563eb;
    --inicio-success: #22c55e;
    --inicio-shadow: 0 18px 48px rgba(2, 8, 23, 0.42);
    --card-bg: rgba(15, 27, 46, 0.72);
...
[data-theme="light"] {
    --inicio-surface: rgba(255, 255, 255, 0.96);
    --inicio-surface-strong: rgba(240, 246, 255, 0.96);
    --inicio-border: rgba(37, 99, 235, 0.18);
    --inicio-text: #0f2340;
    --inicio-muted: #475569;
    --inicio-accent: #3b82f6;
    --inicio-accent-strong: #2563eb;
    --inicio-success: #16a34a;
    --inicio-shadow: 0 18px 42px rgba(15, 35, 80, 0.12);
...
body {
    min-height:100vh;
    background:
        linear-gradient(rgba(7,16,31,0.75), rgba(13,27,52,0.82)),
...
body[data-theme="light"] {
    background:
        linear-gradient(rgba(240,246,255,0.82), rgba(232,240,254,0.90)),
...
.best-img {
    ...
    justify-content: center;
    aspect-ratio: 4 / 3;
    background: linear-gradient(135deg, rgba(59,130,246,0.16), rgba(9,21,37,0.42));
}
...
.sales-bar {
    ...
    background: linear-gradient(90deg, #14b8a6, #3b82f6 52%, #93c5fd 100%);
...
.sales-row.is-active .sales-bar {
    ...
    box-shadow: 0 0 0 1px rgba(255,255,255,0.2), 0 14px 32px rgba(59,130,246,0.34);
}
...
.sales-dashboard:has(.sales-row.is-active) .sales-summary {
    ...
    box-shadow: inset 0 1px 0 rgba(255,255,255,0.08), 0 20px 42px rgba(59,130,246,0.13);
}
...
.sales-ring {
    ...
    place-items: center;
    background:
        radial-gradient(circle at center, rgba(9,21,37,0.9) 0 55%, transparent 57%),
        conic-gradient(#3b82f6 calc(var(--ring-value) * 1%), rgba(148,163,184,0.18) 0);
...
.sketchfab-frame[data-src] {
    background:
        linear-gradient(135deg, rgba(147,197,253,0.12), transparent 58%),
        #0f172a;
}
